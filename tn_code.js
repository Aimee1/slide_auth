...
var tncode = {
    ...
    _send_result:function(){
        ...
        var re = new _ajax();
        // re.request('get','http://192.168.5.148:8090/game_reserves/check_image?tn_r='+tncode._mark_offset+'&'+'game_id=FF000001CL01'+'&'+'slide_auth_token'+slid_auth_token,haddle);
        re.request('get','http://192.168.5.148:8090/game_reserves/check_image?tn_r='+tncode._mark_offset+'&'+'game_id=FF000001CL01',haddle);
    },
    _send_result_success:function(responseText,responseXML){
        tncode._doing = false;
        console.log(responseText);
        if(responseText=='ok{"error_code":"0","error_reason":"success"}'){
    ...
    refresh:function(){
        ...
        // var img_url = "test_image?nowebp="+nowebp+"&t="+Math.random();
        var img_url = "http://192.168.5.148:8090/game_reserves/get_image?nowebp="+nowebp+"&t="+Math.random()+"&game_id=FF000001CL01";
        if(!isSupportWebp){//浏览器不支持webp
            img_url+="&nowebp=1";
        }

        http://192.168.5.175/summary/FFTechnicalSupport%2Fcoeus%2FView.git
    ...
    onsuccess:function(fn){
        console.log("获取图片"+fn+"<br>");
        console.log("slide_auth_token="+fn['slide_auth_token']+"<br>");
